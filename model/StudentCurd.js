...
module.exports = {
  ...
  findStubAndDormitoryNumber(param) {
    const sql = 'SELECT studentNumber,NAME,department,profession,grade,class,phoneNumber,instructName,instructPhone,buildNumber,dormitoryNumber,dormitoryLeader,LeaderPhone,fatherPhone,motherPhone FROM  student WHERE buildNumber=(SELECT stubNumber FROM stub WHERE accountNumber=?) and dormitoryNumber=?';
    return (promise = new Promise(function (resolve, reject) {
  ...
  findStubNameAndId(param) {
    ...
    const sql = `SELECT  studentNumber,NAME,department,profession,grade,class,phoneNumber,instructName,instructPhone,buildNumber,dormitoryNumber,dormitoryLeader,LeaderPhone,fatherPhone,motherPhone FROM  student WHERE buildNumber=(SELECT stubNumber FROM stub WHERE accountNumber=?) and (studentNumber=? ${field} name=?)`;
    return (promise = new Promise(function (resolve, reject) {
